...
describe("[Challenge] Free Rider", function () {
  ...
  it("Execution", async function () {
    ...
    /**
     * STEPS:
     *      1. Borrow 15 WETH from uniswap pool
     *      2. Buy all NFTs in the marketplace thanks to the vulnerability in _buyOne()
     *      3. Transfer all NFTs to Recovery contract and earn the prize
     *      4. Return the WETH borrowed to uniswap
     */
    ...
    await attackContract.flashSwap(NFT_PRICE);
  });
